...
//					"jdbc:mysql://localhost:3306/demo", "root", "741852963");
			
			String dbUrl1 = "jdbc:mysql://localhost:3306/demo?user=root&password=741852963";
			myConn = (Connection)DriverManager.getConnection(dbUrl1);
			...
			myStmt = myConn.prepareCall("{call demo.increase_salaries_for_department(?, ?)}");
